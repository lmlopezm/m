...
/**
 * Provides the information to backup flexible course format
 */
class backup_format_flexible_plugin extends backup_format_plugin {
    ...
    protected function define_course_plugin_structure() {
        ...
        $plugin = $this->get_plugin_element(null, '/course/format', 'flexible');
    ...
    private function delete_displayed_images() {
        ...
        /* We only process this information if the course we are backing up is in the
          'flexible' format (target format can change depending of restore options).
          Note: This appears to be a bit silly as this code is executed even if the
          course is not in the 'flexible' format.
         */
        ...
        require_once($CFG->dirroot . '/course/format/flexible/lib.php'); // For format_flexible.
    ...
    protected function define_section_plugin_structure() {
        ...
        // Define the virtual plugin element with the condition to fulfill.
        $plugin = $this->get_plugin_element(null, $this->get_format_condition(), 'flexible');
        ...
        $pluginwrapper->set_source_table('format_flexible_icon', array(
